...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView,
      @NonNull FloatingActionButton addButton, @NonNull TextView appName,
      @NonNull FrameLayout frameLayout, @NonNull TextView notesHeading,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, addButton, appName, frameLayout,
          notesHeading, notesRecyclerView);
    }
